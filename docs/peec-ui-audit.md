...
| `/landing` | Entrada pública | proposta de valor, canais, benefícios e entradas para autenticação | ainda não consolidado com o sistema NEXO | analisada | revisar corpo completo, responsividade e coerência com a experiência autenticada |
