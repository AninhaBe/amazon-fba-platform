...
test("a faixa Amazon não volta a renderizar a base como legenda", async () => {
  // INTENÇÃO ALTERADA EM 13/09/2026: a declaração na face cumpria a regra de
  // leitura, mas alongava só a Amazon. A dona pediu a retirada das legendas e
  // as faltas continuam no bloco próprio de pendências.
